...
namespace FFHPWeb
{
    public partial class Ordernumbers : System.Web.UI.Page
    {
...
and z.increment_id in (" + ordernumbers.ToString() + ")";
        ...
        public void generatepdf1()
        {
            ...
            {
                widths[x] = 120;//(int)dlordernumber.ItemStyle.Width.Value;
                //string cellText = Server.HtmlDecode(GvPackList3.HeaderRow.Cells[x].Text);
                ...
                string cellText = "";
                Label ordno = dlordernumber.Items[x].FindControl("lblordernumber") as Label;
            ...
            //{
                ...
                //for (int j = k; j < dlordernumber.RepeatColumns; j++)
                for (int j = k; j < dlordernumber.Items.Count; j++)
                {
                    int m=0;
                    string cellText = "";
                    //if (j != 0)
                    //{
                        Label ordno = dlordernumber.Items[j].FindControl("lblordernumber") as Label;
                        string item = ordno.Text;
                        cellText = Server.HtmlDecode(item);
                    //}
                    //else
        ...
        public void bindordernumber()
        {
            ...
            string ordernumber = "";
                ...
                ordernumberlist = getroutelistone(1);
