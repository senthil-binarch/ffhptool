<%@ Page Title="" Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="TotalWeightlprdata.aspx.cs" Inherits="FFHPWeb.TotalWeightlprdata" Theme="Skin1" %>
...
--%>    <asp:BoundField DataField="TotalWeight"  HtmlEncode="False" HeaderText="Total Weight" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
    ...
    <asp:BoundField DataField="Product_Id" HeaderText="PID" ItemStyle-Width="30px" />
...
--%>    <asp:BoundField DataField="TotalWeight"  HtmlEncode="False" HeaderText="Total Weight" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-Width="90px" />
        ...
        <asp:BoundField DataField="PackingStyle" HeaderText="Packing Style" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" ItemStyle-Width="90px" />
    </Columns>
    </asp:GridView>
    </td>
    </tr>
