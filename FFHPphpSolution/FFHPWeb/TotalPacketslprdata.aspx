<%@ Page Title="" Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="TotalPacketslprdata.aspx.cs" Inherits="FFHPWeb.TotalPacketlprdata" Theme="Skin1" %>
...
<table width="100%">
<tr>
<td class="lblheading">Packets Details</td>
</tr>
<tr>
    <td>
    <table>
...
Height="32px" onclick="btnXLS_Click"/></td>
    ...
    <tr>
    <td valign="top" align="left"><asp:GridView ID="GvPackList" runat="server">
    <Columns>
    ...
    <td valign="top" align="left"><asp:GridView ID="GvPackList2" runat="server">
    <Columns>
    <asp:TemplateField HeaderText="Serial No">                   
    <ItemTemplate>
    <%#Container.DataItemIndex + 1 %>
    ...
    <asp:BoundField DataField="Weight" HeaderText="Weight" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
    <asp:BoundField DataField="Units" HeaderText="Units" ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Left" />
   <%-- <asp:BoundField DataField="Pack" HeaderText="No. of Pack" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
--%>    <asp:BoundField DataField="Pack"  HtmlEncode="False" HeaderText="No. of Packets" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right"  ItemStyle-Width="100px" />
    <asp:BoundField DataField="PackingStyle" HeaderText="Packing Style" ItemStyle-HorizontalAlign="Center"  ItemStyle-Width="100px" />
    </Columns>
    </asp:GridView>
    </td>
    </tr>
...
<%--    <asp:BoundField DataField="Weight" HeaderText="Weight" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
    <asp:BoundField DataField="Pack" HeaderText="No. of Pack" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
--%>    <asp:BoundField DataField="Pack"  HtmlEncode="False" HeaderText="No. of Packets" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
    </Columns>
    </asp:GridView>
    </td>
    </tr>
