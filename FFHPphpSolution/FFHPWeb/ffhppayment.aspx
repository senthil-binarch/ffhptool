<%@ Page Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="ffhppayment.aspx.cs" Inherits="FFHPWeb.ffhppayment" Theme="Skin1"%>
...
Height="32px" onclick="btnXLS_Click"/></td>
    ...
    <%--<%#Container.DataItemIndex + 1 %>--%>
        ...
        <asp:BoundField DataField="Amount" HeaderText="COD Amount" HeaderStyle-HorizontalAlign="Right" ItemStyle-Width="150px" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
        <asp:BoundField DataField="EBSAmount" HeaderText="EBS Amount" ItemStyle-Width="170px" />
        </Columns>
        </asp:GridView>
    </td>
    </tr>
