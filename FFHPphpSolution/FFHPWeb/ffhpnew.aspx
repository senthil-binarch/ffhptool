<%@ Page Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="ffhpnew.aspx.cs" Inherits="FFHPWeb.ffhpnew" Theme="Skin1"%>
...
<td><asp:TextBox ID="TbxToDate" Width="75px" runat="server" ></asp:TextBox><asp:Image
    ...
    <HeaderTemplate>
    <asp:CheckBox ID="CODall" Text="COD" OnCheckedChanged="CODall_OnCheckedChanged" runat="server" AutoPostBack="true" /><asp:HiddenField ID="HFcodordernum" Value='<%#Bind("entity_id") %>' runat="server" />
    </HeaderTemplate>
    <ItemTemplate>
...
<td>COD Order No: </td>
<td><asp:TextBox ID="txtcodidlist" TextMode="MultiLine" Height="50px" Width="250px" runat="server"></asp:TextBox></td>
<%--<td><asp:Button ID="btncodsubmit" Text="Submit" OnClick="btncodsubmit_OnClick" runat="server" /></td>--%>
    </tr>
    </table>
    </td>
    </tr>
    ...
    <%--<%#Container.DataItemIndex + 1 %>--%>
        ...
        <asp:BoundField DataField="Date" HeaderText="Ordered Date" ItemStyle-Width="140px" />
        <asp:BoundField DataField="customername" HeaderText="Name" ItemStyle-Width="240px" HtmlEncode="false" />
        <asp:BoundField DataField="Address" HeaderText="Address" ItemStyle-Width="400px" />
        <asp:BoundField DataField="Name" HeaderText="Route" ItemStyle-Width="170px" />
        ...
        <asp:BoundField DataField="Zipcode" HeaderText="Zipcode" ItemStyle-Width="140px" />
        <asp:BoundField DataField="shipping_description" HeaderText="shipping description" ItemStyle-Width="140px" />
        <asp:BoundField DataField="customer_as" HeaderText="Customer as" ItemStyle-Width="140px" />
        <asp:BoundField DataField="goonj" HeaderText="Goonj" ItemStyle-Width="140px" />
        <asp:BoundField DataField="paymentmethod" HeaderText="Method" ItemStyle-Width="140px" />
        <asp:BoundField DataField="rewardspoints" HeaderText="Rewardspoints" ItemStyle-Width="140px" />
        </Columns>
        </asp:GridView>
    </td>
    </tr>
