<%@ Page Title="" Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="TotalPacketsSummary1.aspx.cs" Inherits="FFHPWeb.TotalPacketsSummary1" Theme="Skin1" %>
...
<table width="100%">
<tr>
<td class="lblheading">Packets Summary</td>
</tr>
<tr>
    <td>
    <table>
...
Height="32px" onclick="btnXLS_Click"/></td>
    ...
    <asp:BoundField DataField="Name" HeaderText="Name" ItemStyle-Width="260px" />
    <asp:BoundField DataField="Weight" HeaderText="Weight" ItemStyle-Width="60px" />
<%--    <asp:BoundField DataField="Weight" HeaderText="Weight" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
    <asp:BoundField DataField="Pack" HeaderText="No. of Pack" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" />
