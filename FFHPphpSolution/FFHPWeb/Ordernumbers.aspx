<%@ Page Title="" Language="C#" MasterPageFile="~/FFHP.Master" AutoEventWireup="true" CodeBehind="Ordernumbers.aspx.cs" Inherits="FFHPWeb.Ordernumbers" Theme="Skin1" %>
...
<td><asp:TextBox ID="TbxToDate" Width="75px" runat="server" ></asp:TextBox><asp:Image
    ...
    <tr>
    <td>
    <asp:DataList ID="dlordernumber" runat="server" RepeatDirection="Horizontal" RepeatColumns="4" EnableTheming="false" Width="100%">
    <ItemTemplate>
